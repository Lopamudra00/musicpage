...
function Experience() {
    ...
    return (
        ...
        <div className="experience flex flex-col items-center justify-start px-[5rem] bg-[#020917] h-[63rem] pt-[18rem] mt-[-10rem] relative z-[-2] rounded-b-[5rem]">
            <img src={require("../img/Path 318.png")} alt="" className="w-[5rem]" />

            <div className="headline mt-7 flex flex-col items-center text-[2rem]">
                <span>An Amazing App Can Change Your Daily Life
